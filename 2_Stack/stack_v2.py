...
class Stack:
    ...
    Note:
        In this version, push and pop both work at the head of the list, which makes them O(1).
    """
    def __init__(self):
        self.head = None
    ...
    def push(self, data):
        ...
        Time Complexity:
            - O(1): Inserts directly at the head.
        Space Complexity:
    ...
    def pop(self):
        ...
        Time Complexity:
            - O(1): Removes directly from the head.
        Space Complexity:
...
if __name__ == "__main__":
    ...
    # Print stack
    stack.print_stack()  # Stack Elements: 40 30 20 10
